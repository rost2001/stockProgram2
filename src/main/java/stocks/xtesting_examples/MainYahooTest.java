...
public class MainYahooTest {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		/*
		 * Vol relative , so vol divided by shares = relative vol and vol times shares = omsättning
		 ...
		 * If number of shares is more than marketcap, omsättning(vol) compared to marketcap how many times is it traded whole, average vol compared to mkt
